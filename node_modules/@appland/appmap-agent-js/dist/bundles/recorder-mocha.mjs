...
const { Boolean: Boolean$2, Error: Error$7, Number: Number$1, undefined: undefined$c } = globalThis;
    ...
    .map(([, method, loc1, loc2], level) => {
      ...
      if (fileName) {
        return {
          ...
          level,
          method: method || "",
          line: Number$1(line || 0),
          column: Number$1(column || 0),
        };
      }
      return undefined$c;
    })
...
const { undefined: undefined$1, parseInt, Boolean, Promise: Promise$1 } = globalThis;
...
const recordAsync = (configuration) => {
  ...
  hooks$1.afterEach = (context) => {
    ...
    recordStopTrack(frontend, running.track, {
      type: "test",
      passed,
      failure: passed ? undefined$1 : buildTestFailure(context.currentTest.err),
    });
    flush();
    running = null;
  };
